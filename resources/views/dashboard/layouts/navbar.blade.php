                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @can('isAdmin')
                                    @forelse($notifications as $notif)
                                        <a class="dropdown-item d-flex align-items-center" href="{{ route('janjitemu') }}">
                                            <div class="mr-3">
                                ...
                                @can('isDokter')
                                    @forelse($notifications as $notif)
                                        <a class="dropdown-item d-flex align-items-center" href="{{ route('janjitemuDok') }}">
                                            <div class="mr-3">
                                                <div class="icon-circle bg-primary">
                                                    <i class="fas fa-file-alt text-white"></i>
                                                </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=4e73df&color=fff&size=28"
                                class="rounded-circle shadow-sm" alt="User Avatar">
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button id="btn-logout" class="dropdown-item"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Logout</button>
                                </form>
