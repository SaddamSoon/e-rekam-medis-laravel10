...
<div class="card shadow mb-4" style="width: 50rem;">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Tambah About</h6>
    </div>
    <div class="card card-body">
        <form id="myForm" method="POST" action="{{ route('about.store') }}" enctype="multipart/form-data">
            @csrf
        ...
        <a class="btn border-danger text-decoration-none" href="{{ route('about') }}">Batal</a>
    </form>
    </div>
</div>
@endsection
...
@push('script')
    <script>
        ...
        // trix delete tools file
        document.addEventListener('trix-file-accept', function(e){
        e.preventDefault();
      });
        //batasi input form lebih 1 kali   
